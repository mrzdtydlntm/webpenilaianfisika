# Generated by Django 3.1.7 on 2021-04-22 03:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('indeks_prosiding', models.CharField(blank=True, choices=[('Scopus dan Scimagojr', 'Scopus dan Scimagojr'), ('Scopus atau IEEE', 'Scopus atau IEEE'), ('Google Scholar', 'Google Scholar'), ('Discontinued dan Cancelled', 'Discontinued dan Cancelled'), ('Tidak Terindeks', 'Tidak Terindeks')], max_length=255, null=True, verbose_name='Terindeks di')),
                ...
                ('corresponding_author_selain', models.CharField(blank=True, max_length=100, null=True, verbose_name='Corresponding Author Selain Dosen')),
                ('penulis_utama_selain', models.CharField(blank=True, max_length=100, null=True, verbose_name='Penulis Utama Selain Dosen')),
                ('penulis_selain', models.CharField(blank=True, max_length=100, null=True, verbose_name='Penulis Selain Dosen')),
                ('is_verificated', models.BooleanField(blank=True, default=None, null=True)),
                ('uploaded', models.DateTimeField(auto_now_add=True)),
                ('slug', models.SlugField(blank=True, editable=False, unique=True)),
                ('corresponding_author', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='user_prosiding_corresponding_author', to='penilaian.users', verbose_name='Corresponding Author')),
                ('penulis_lain', models.ManyToManyField(blank=True, to='penilaian.Users')),
                ('penulis_utama', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='user_prosiding_penulis_utama', to='penilaian.users', verbose_name='Penulis Utama')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('indeks_jurnal', models.CharField(blank=True, choices=[('Scopus dan Scimagojr', 'Scopus dan Scimagojr'), ('Scopus atau IEEE', 'Scopus atau IEEE'), ('Google Scholar', 'Google Scholar'), ('Discontinued dan Cancelled', 'Discontinued dan Cancelled'), ('Tidak Terindeks', 'Tidak Terindeks')], max_length=100, null=True, verbose_name='Indeks Jurnal')),
                ...
                ('corresponding_author_selain', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ca_selain', to='penilaian.penulislain')),
                ('penulis_lain', models.ManyToManyField(blank=True, to='penilaian.Users')),
                ...
                ('penulis_utama_selain', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pu_selain', to='penilaian.penulislain')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pemegang_berkas_utama_selain', models.CharField(blank=True, max_length=100, null=True, verbose_name='Pemegang Berkas Utama Selain Dosen')),
                ('pemegang_berkas_selain', models.CharField(blank=True, max_length=100, null=True, verbose_name='Pemegang Berkas Selain Dosen')),
                ('is_verificated', models.BooleanField(blank=True, default=None, null=True)),
                ('uploaded', models.DateTimeField(auto_now_add=True)),
                ('slug', models.SlugField(blank=True, editable=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('penulis_utama_selain', models.CharField(blank=True, max_length=100, null=True, verbose_name='Penulis Utama Selain Dosen')),
                ('penulis_lain_selain', models.CharField(blank=True, max_length=100, null=True, verbose_name='Penulis Lain Selain Dosen')),
                ('is_verificated', models.BooleanField(blank=True, default=None, null=True)),
                ('uploaded', models.DateTimeField(auto_now_add=True)),
                ('slug', models.SlugField(blank=True, editable=False, unique=True)),
                ('penulis_lain', models.ManyToManyField(blank=True, to='penilaian.Users')),
